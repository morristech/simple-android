  ...
  private fun `params for placeholder bp items`(): List<List<Any>> {
    ...
    return listOf(
        ...
        listOf<Any>(
            ...
            listOf(
                SummaryBloodPressureListItem(measurement = bpsForTest2[0], displayDaysTimestamp = Today, showDivider = true, displayTime = displayTime, firstInGroup = true)
            )
        ),
        listOf<Any>(
            bpsForTest3,
            ...
            listOf(
                SummaryBloodPressureListItem(measurement = bpsForTest3[0], displayDaysTimestamp = Today, showDivider = true, displayTime = displayTime, firstInGroup = true),
                SummaryBloodPressureListItem(measurement = bpsForTest3[1], displayDaysTimestamp = Today, showDivider = true, displayTime = displayTime, firstInGroup = true)
            )
        ),
        listOf<Any>(
            bpsForTest4,
            ...
            listOf(
                SummaryBloodPressureListItem(measurement = bpsForTest4[0], displayDaysTimestamp = Today, showDivider = true, displayTime = displayTime, firstInGroup = true),
                SummaryBloodPressureListItem(measurement = bpsForTest4[1], displayDaysTimestamp = Today, showDivider = true, displayTime = displayTime, firstInGroup = true),
                SummaryBloodPressureListItem(measurement = bpsForTest4[2], displayDaysTimestamp = Today, showDivider = true, displayTime = displayTime, firstInGroup = true)
            )
        ),
        listOf<Any>(
            bpsForTest5,
            ...
            listOf(
                SummaryBloodPressureListItem(measurement = bpsForTest5[0], displayDaysTimestamp = Today, showDivider = true, displayTime = displayTime, firstInGroup = true),
                SummaryBloodPressureListItem(measurement = bpsForTest5[1], displayDaysTimestamp = Today, showDivider = true, displayTime = displayTime, firstInGroup = true),
                SummaryBloodPressureListItem(measurement = bpsForTest5[2], displayDaysTimestamp = Today, showDivider = true, displayTime = displayTime, firstInGroup = true)
            )
        ),
        listOf<Any>(
            bpsForTest6,
            ...
            listOf(
                SummaryBloodPressureListItem(measurement = bpsForTest6[0], displayDaysTimestamp = Today, showDivider = true, displayTime = displayTime, firstInGroup = true),
                SummaryBloodPressureListItem(measurement = bpsForTest6[1], displayDaysTimestamp = Today, showDivider = true, displayTime = displayTime, firstInGroup = true),
                SummaryBloodPressureListItem(measurement = bpsForTest6[2], displayDaysTimestamp = Today, showDivider = true, displayTime = displayTime, firstInGroup = true)
            )
        )
    )
  }
  ...
  private fun `params for BP grouped by date`(): List<List<Any>> {
    ...
    return listOf(
        listOf<Any>(
            bpsForTest1,
            listOf(
                SummaryBloodPressureListItem(measurement = bpsForTest1[0], displayDaysTimestamp = Today, showDivider = false, displayTime = displayTime(bpsForTest1[0].createdAt), firstInGroup = true),
                SummaryBloodPressureListItem(measurement = bpsForTest1[1], displayDaysTimestamp = Today, showDivider = true, displayTime = displayTime(bpsForTest1[1].createdAt), firstInGroup = true),
                SummaryBloodPressureListItem(measurement = bpsForTest1[2], displayDaysTimestamp = Today, showDivider = true, displayTime = null, firstInGroup = true)
            )),
        listOf<Any>(
            bpsForTest2,
            listOf(
                SummaryBloodPressureListItem(measurement = bpsForTest2[0], displayDaysTimestamp = Today, showDivider = false, displayTime = displayTime(bpsForTest2[0].createdAt), firstInGroup = true),
                SummaryBloodPressureListItem(measurement = bpsForTest2[1], displayDaysTimestamp = Today, showDivider = true, displayTime = displayTime(bpsForTest2[1].createdAt), firstInGroup = true),
                SummaryBloodPressureListItem(measurement = bpsForTest2[2], displayDaysTimestamp = Today, showDivider = false, displayTime = displayTime(bpsForTest2[2].createdAt), firstInGroup = true),
                SummaryBloodPressureListItem(measurement = bpsForTest2[3], displayDaysTimestamp = Today, showDivider = true, displayTime = displayTime(bpsForTest2[3].createdAt), firstInGroup = true),
                SummaryBloodPressureListItem(measurement = bpsForTest2[4], displayDaysTimestamp = Today, showDivider = true, displayTime = null, firstInGroup = true)
            ))
    )
  }
